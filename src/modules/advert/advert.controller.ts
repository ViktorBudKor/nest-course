...
export class AdvertController {
  ...
  @ApiResponse({
    status: 200,
    description: 'Возвращает список опубликованных объявлений',
  })
  findPublishedAd() {
  ...
  @ApiResponse({
    status: 200,
    description: 'Возвращает объявления текущего пользователя',
  })
  ...
  @ApiResponse({
    status: 200,
    description: 'Статус объявления успешно обновлен',
  })
  ...
  @ApiResponse({
    status: 406,
    description: 'Вы не можете изменить это объявление',
  })
  updatePublished(
    @Body() publishedAdvertDto: PublishedAdvertDto,
    @Request() req,
  ) {
  ...
  @ApiResponse({
    status: 200,
    description: 'Возвращает объявления на рассмотрении',
  })
  @ApiResponse({ status: 403, description: 'Доступ запрещен' })
  findChecking() {
